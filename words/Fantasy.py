...
def get_all():
	...
	d["faction"] 		= [	"demonic", "orcish", "human", "elvish", "werewolf", "angelic", "undead", "lizard", "avian", "halfling",
	...
	d["evil_god"] 		= [	"terror of war", "unspeakable", "spider queen", "{god} of darkness", "demon king", "{god} of death", "{god} of madness"]
	d["good_god"]			= [	"{god} of tactics", "{god} of harvest", "{god} of order", "{god} of metalurgie", "{god} of justice", 
	...
	d["plural"]			= {"wolf":"wolves", "fox":"foxes", "direwolf":"direwolves", "werewolf":"werewolves"}
	return d
